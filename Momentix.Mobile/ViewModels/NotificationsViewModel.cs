...
public partial class NotificationsViewModel : BaseViewModel
{
    ...
    public IRelayCommand<NotificationResponseDto> OpenNotificationCommand =>
        new AsyncRelayCommand<NotificationResponseDto>(OpenNotification);
    ...
    private async Task MarkAllAsRead()
    {
        ...
        StatusMessage = success ? "Известията са маркирани като прочетени." : _apiService.LastErrorMessage;
        await Load();
    }
