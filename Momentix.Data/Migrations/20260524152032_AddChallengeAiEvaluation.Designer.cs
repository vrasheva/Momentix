...
namespace Momentix.Data.Migrations
{
    ...
    [Migration("20260524152032_AddChallengeAiEvaluation")]
    partial class AddChallengeAiEvaluation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Momentix.Data.Models.Friend", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Momentix.Data.Models.Notification", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Momentix.Data.Models.Friend", b =>
                {
                    b.HasOne("Momentix.Data.Models.User", "FriendUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Momentix.Data.Models.Notification", b =>
                {
                    b.HasOne("Momentix.Data.Models.User", "ActorUser")
                        .WithMany()
