        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RevealAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    UnlockAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AlbumMembers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                })
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeCapsuleId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_MediaItems_TimeCapsules_TimeCapsuleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TimeCapsuleMembers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TimeCapsuleMembers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TimeCapsuleMembers_TimeCapsules_TimeCapsuleId",
                        column: x => x.TimeCapsuleId,
                        principalTable: "TimeCapsules",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VotedByUserId = table.Column<string>(type: "varchar(255)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChallengeVotes_AspNetUsers_VotedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlbumMembers_AlbumId_UserId",
                table: "AlbumMembers",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChallengeVotes_SubmissionId_VotedByUserId",
                table: "ChallengeVotes",
                columns: new[] { "SubmissionId", "VotedByUserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ChallengeVotes_VotedByUserId",
                table: "ChallengeVotes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaItems_TimeCapsuleId",
                table: "MediaItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TimeCapsuleMembers_TimeCapsuleId_UserId",
                table: "TimeCapsuleMembers",
                columns: new[] { "TimeCapsuleId", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimeCapsuleMembers_UserId",
                table: "TimeCapsuleMembers",
                column: "UserId");
